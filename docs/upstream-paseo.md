...
- Subscribe the self-hosted Web browser pane to browser-store hydration so
  persisted dashboard tabs recover after reload; tolerate legacy
  `https:///dispatch-dashboard/...` values generated by earlier local bundles.
